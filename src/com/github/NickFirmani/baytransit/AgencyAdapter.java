...
public class AgencyAdapter extends BaseAdapter {
	...
	private void buildarray() {
		...
		Agency a8 = new Agency(res.getString(R.string.a8_c), R.drawable.samtrans, res.getString(R.string.a8_p));
		Agency a9 = new Agency(res.getString(R.string.a9_c), R.drawable.muni, res.getString(R.string.a9_p)); //FIXME
